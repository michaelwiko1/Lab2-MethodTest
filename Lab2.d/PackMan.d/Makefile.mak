...
EXC = VladPackManGame
OBJS = Cookie.o VladPackManGame.o Board.o ListBoardObjects.o Player.o Wall.o VectorBoardObject.o
DBG=-g
...
VectorBoardObject.o : VectorBoardObjectH.h BoardObjectH.h VectorBoardObject.cpp PlayerH.h CookieH.h
	g++ $(DBG) -c VectorBoardObject.cpp -o VectorBoardObject.o
